...
// RepairIgnoredTables drops and recreates all dolt_ignore'd wisp tables.
// These tables are working-set only, so rebuilding them is a safe repair path
// for checksum corruption in ignored-table data.
